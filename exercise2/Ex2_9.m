...
txAngle = -35/180*pi;       % Transmit beam angle
rxAngle = -35/180*pi;       % Receive beam angle
...
xStart = -40/1000;      % Start position of measurement points in x direction
xEnd = 40/1000;         % End position of measurement points in x direction
