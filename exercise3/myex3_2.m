...
show2dFourier = 1;          % Plot 2D Fourier transform of your image
oversamplingratio = 8;      % Oversampling based on Nyquist of the transmit beams
...
r_start = 7.5/1000; r_end = 10.5/1000; N_rp = 10; phi_r = 0*pi/180;
...
%iqData_d = iqData(:,1:D:size(iqData,2));
%theDet = abs(iqData_d);
theDet_n = theDet/max(max(theDet))+1e-12;
theDetComp = 10*log10(theDet_n);
